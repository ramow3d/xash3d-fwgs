...
void GL_InitExtensions( void )
{
	...
	{
		cvar_t *fake = gEngfuncs.Cvar_Get( "cl_fake_android", "1", FCVAR_ARCHIVE, "Force fake Android identity (0/1)" );
		if( fake && fake->value )
		{
			...
			glConfig.extensions_string = "GL_OES_element_index_uint GL_OES_vertex_array_object GL_EXT_texture_format_BGRA8888 GL_OES_depth_texture GL_OES_packed_depth_stencil GL_OES_rgb8_rgba8 GL_OES_standard_derivatives GL_EXT_texture_type_2_10_10_10_REV GL_OES_EGL_image GL_OES_EGL_image_external GL_OES_EGL_sync GL_OES_texture_npot GL_EXT_draw_buffers GL_EXT_texture_filter_anisotropic GL_EXT_texture_compression_dxt1 GL_EXT_texture_compression_s3tc GL_EXT_texture_compression_s3tc_srgb GL_QCOM_binning_control GL_QCOM_alpha_test GL_QCOM_driver_control GL_QCOM_perfmon_global_mode GL_QCOM_writeonly_rendering GL_QCOM_tiled_rendering GL_EXT_sRGB GL_EXT_sRGB_write_control GL_EXT_texture_sRGB_decode GL_EXT_texture_sRGB_R8 GL_EXT_texture_sRGB_RG8 GL_EXT_frag_depth GL_EXT_blend_minmax GL_EXT_discard_framebuffer GL_EXT_multisampled_renderbuffer GL_EXT_instanced_arrays GL_EXT_draw_instanced GL_EXT_texture_border_clamp GL_EXT_texture_buffer GL_EXT_float_blend GL_EXT_unpack_subimage GL_EXT_texture_cube_map_array GL_EXT_color_buffer_float GL_EXT_color_buffer_half_float GL_EXT_occlusion_query_boolean GL_EXT_texture_stencil8 GL_EXT_shader_texture_lod GL_EXT_shadow_samplers GL_EXT_shader_framebuffer_fetch GL_EXT_shader_pixel_local_storage GL_EXT_shader_pixel_local_storage2 GL_EXT_post_depth_coverage GL_EXT_raster_multisample GL_EXT_texture_view GL_EXT_multiview_draw_buffers GL_EXT_draw_buffers_indexed GL_EXT_gpu_shader5 GL_EXT_separate_shader_objects GL_EXT_tessellation_shader GL_EXT_tessellation_point_size GL_EXT_primitive_bounding_box GL_EXT_shader_io_blocks GL_EXT_geometry_shader GL_EXT_texture_border_clamp GL_EXT_geometry_point_size GL_EXT_clip_cull_distance GL_EXT_disjoint_timer_query GL_EXT_clip_control GL_EXT_texture_compression_s3tc_srgb GL_EXT_sRGB GL_EXT_sRGB_write_control GL_EXT_texture_sRGB_decode GL_EXT_texture_sRGB_R8 GL_EXT_texture_sRGB_RG8 GL_EXT_frag_depth GL_EXT_blend_minmax GL_EXT_discard_framebuffer GL_EXT_multisampled_renderbuffer GL_EXT_instanced_arrays GL_EXT_draw_instanced GL_EXT_texture_border_clamp GL_EXT_texture_buffer GL_EXT_float_blend GL_EXT_unpack_subimage GL_EXT_texture_cube_map_array GL_EXT_color_buffer_float GL_EXT_color_buffer_half_float GL_EXT_occlusion_query_boolean GL_EXT_texture_stencil8 GL_EXT_shader_texture_lod GL_EXT_shadow_samplers GL_EXT_shader_framebuffer_fetch GL_EXT_shader_pixel_local_storage GL_EXT_shader_pixel_local_storage2 GL_EXT_post_depth_coverage GL_EXT_raster_multisample GL_EXT_texture_view GL_EXT_multiview_draw_buffers GL_EXT_draw_buffers_indexed GL_EXT_gpu_shader5 GL_EXT_separate_shader_objects GL_EXT_tessellation_shader GL_EXT_tessellation_point_size GL_EXT_primitive_bounding_box GL_EXT_shader_io_blocks GL_EXT_geometry_shader GL_EXT_texture_border_clamp GL_EXT_geometry_point_size GL_EXT_clip_cull_distance GL_EXT_disjoint_timer_query GL_EXT_clip_control";
		}
	}
